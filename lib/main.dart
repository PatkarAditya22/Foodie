  ...
  void _setFilters(Map<String,bool>filterData){
    setState(() {
      ...
      _availableMeals = DUMMY_MEALS.where((meal){
        ...
        if(_filters['glucose'] && !meal.isLactoseFree){
          return false;
        }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/categoriesmeal': (ctx) => CategoriesMealsScreen(_availableMeals),
        '/meal-info': (ctx) => MealScreen(_toggleFavorite,_isFavorite),
        '/filters': (ctx) => FiltersScreen(_filters,_setFilters),
        '/developer': (ctx) => DeveloperaScreen(),
      },
